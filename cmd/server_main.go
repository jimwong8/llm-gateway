...
func main() {
	...
	var semanticCache semantic.L2Cache
	if cfg.SemanticCacheEnabled {
		sc := semantic.New(cfg.QdrantURL, cfg.QdrantAPIKey, cfg.QdrantCollection, cfg.SemanticVectorSize, cfg.SemanticCacheThreshold)
