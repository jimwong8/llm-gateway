...
func TestDefaultPipelineRunWithNoops(t *testing.T) {
	...
	if result.OriginalRequest.Messages[0].Role != req.Messages[0].Role || result.OriginalRequest.Messages[0].Content != req.Messages[0].Content || result.ProcessedRequest.Messages[0].Role != req.Messages[0].Role || result.ProcessedRequest.Messages[0].Content != req.Messages[0].Content {
